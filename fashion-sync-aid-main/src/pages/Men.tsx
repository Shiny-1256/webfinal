      ...
      <main className="flex-grow pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-serif font-medium mb-4">Men's Collection</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore our selection of men's fashion, from stylish suits to casual everyday essentials.
            </p>
          </div>
